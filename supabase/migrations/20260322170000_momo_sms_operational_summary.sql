-- ============================================================================
-- Cool App - Admin summary for the MoMo SMS pipeline
-- ============================================================================
...
comment on function public.get_momo_sms_operational_summary() is
  'Admin-only MoMo SMS operational summary spanning device sync audits, parse pressure, reconciliation backlog, and retention backlog.';

revoke all on function public.get_momo_sms_operational_summary() from public;
grant execute on function public.get_momo_sms_operational_summary() to authenticated;
