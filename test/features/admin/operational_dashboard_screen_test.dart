          ...
          adminOperationalTriageIssuesProvider.overrideWith(
            (ref) async => <Map<String, dynamic>>[
              <String, dynamic>{
                ...
                'detail':
                    'Payment reference MOMO-PAY-123 has been pending for 28 minutes and has not reconciled.',
                'subject_table': 'pending_transactions',
                'subject_id': 'pending-1',
                'reference': 'MOMO-PAY-123',
          ...
          adminRecentOperationalHealthEventsProvider.overrideWith(
            (ref) async => <Map<String, dynamic>>[
              <String, dynamic>{
                ...
                'component': 'partner_momo',
                'status': 'ok',
                'severity': 'info',
                'issue_code': null,
                'message': 'Partner MoMo checkout opened successfully.',
                'function_name': null,
