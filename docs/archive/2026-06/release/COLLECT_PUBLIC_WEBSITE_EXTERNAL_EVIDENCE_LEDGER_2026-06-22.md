...
| Visual QA | In-app browser and Playwright/Chrome screenshot automation timed out after the full page restore. Fresh route evidence is not claimed for this restore pass. | Open |
...
| route evidence | Exact-dimension screenshots or owner visual approval after the full page restore. | Open. Browser screenshot automation timed out during this restore pass. | Regenerate screenshots or approve visual state manually. |
