...
| Policy URLs | `https://collect.ikanisa.com/#/privacy` is the official Play privacy, account deletion, and data deletion URL. The public fallback contains the privacy policy plus web account/data deletion request instructions for automated review. Play Console Privacy policy, Delete account URL, and Delete data URL were saved with this URL on 2026-06-22. | In Google review | Monitor Publishing overview until Google accepts and publishes the corrected URL metadata. |
