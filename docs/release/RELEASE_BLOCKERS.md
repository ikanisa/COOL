...
validated on a real Android SMS device, deployed as a live Admin PWA, and
approved for the current Android/iOS release scope.
...
- `scripts/release_status.sh --json`: blocked on product signoff, Android SMS
  device UAT, Admin PWA live URL, Android signing review, iOS scope, and
