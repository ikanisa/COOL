...
| `MOBILE_ROUTE_RENDER_SUMMARY=.cache/mobile_route_render_smoke/20260630T160720Z/summary.json ANDROID_DEVICE_UAT_SUMMARY=.cache/android_device_uat/20260630T162322Z_upload_key_debug/summary.json scripts/collect_mobile_design_compliance_audit.sh --json` | Pass | Saved JSON at `docs/release/mobile_design_compliance_audit_2026-06-30.json`; 30 routes, 27 product screens, 0 failed checks |
