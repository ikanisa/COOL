...
| Release worktree review | Pass | `scripts/release_worktree_review_gate.sh --json` passed on 2026-06-02T09:14:42Z with `main` clean and synced to `origin/main` (`ahead=0`, `behind=0`). |
