...
| --- | --- | --- | --- | --- | --- |
| UAT-01 | Contributor | Open shared group, enter amount, tap Contribute, create intent, launch MoMo USSD. | Intent is linked to group, user id, Collect ID, amount, receiver, and contributor sender hash; no manual payment report is shown. | Local tests; linked rollback UAT. | Backend pass; device UAT pending. |
