...
| Release branch sync | Controlled | Worktree review must pass on the exact final release branch after any recorder, evidence, or release-doc refresh is committed and synced; release-owner review is still required before GO. |
