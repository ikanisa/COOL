...
| android_accessibility_structural_uat | Native Android structural accessibility capture with TalkBack enabled | Pass | `.cache/android_accessibility_pixel4a/20260629T042835Z/summary.json`, `scripts/android_accessibility_structural_evidence.sh --json` | Human auditory TalkBack review remains separate from this structural gate |
