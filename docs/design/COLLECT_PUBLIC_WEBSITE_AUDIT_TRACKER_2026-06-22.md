...
- 2026-06-22 local proof: generated `build/public_web` includes `/`, `/group-savings/`, `/diaspora/`, `/credit-readiness/`, `/craas/`, `/community-groups/`, `/protection/`, `/insurance/`, `/partners/`, `/our-partners/`, `/impact/`, `/trust/`, `/security/`, `/privacy/`, `/terms/`, `/account-deletion/`, and `/data-deletion/`; it does not generate `/rw/` or `/fr/`.
...
- 2026-06-22 page restoration proof: `docs/release/COLLECT_PUBLIC_WEBSITE_PAGE_RESTORE_EVIDENCE_2026-06-22.md` records one-by-one live checks for Group Savings, Diaspora, Insurance, CRaaS, Community Groups, Impact, Our Partners, Privacy, Account Deletion, Data Deletion, and Terms.
