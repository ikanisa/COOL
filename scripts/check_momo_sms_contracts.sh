...
bash -n scripts/verify_momo_sms_supabase_rollout.sh
bash -n scripts/seed_android_momo_sms_test_inbox.sh
bash -n scripts/run_momo_sms_device_integration.sh
...
"$FLUTTER_BIN" test \
  ...
  test/features/momo/momo_sms_sender_policy_alignment_test.dart \
