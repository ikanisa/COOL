...
route_specs=(
  ...
  "contribute-entry|/contribute|primary"
  "activity|/activity|primary"
  "group-create|/groups/create|workflow"
  "group-scan|/groups/scan|workflow"
  "group-detail|/groups/qa-private-group|workflow"
  "share|/groups/qa-private-group/share|workflow"
  "invite|/groups/qa-private-group/invite|compatibility"
  "shared-group-link|/c/qa-private-group|entry"
  ...
  "contribution|/groups/qa-private-group/contribute|workflow"
  "ledger|/groups/qa-private-group/ledger|workflow"
  "manage|/groups/qa-private-group/manage|workflow"
  "group-profile|/groups/qa-private-group/profile|workflow"
  "members|/groups/qa-private-group/members|workflow"
  ...
  "settings-security|/settings/security|utility"
