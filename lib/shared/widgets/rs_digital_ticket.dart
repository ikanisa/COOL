  ...
  Widget build(BuildContext context) {
    ...
    final statusNote = switch (ticket.status) {
      RsTicketStatus.pending =>
        'Payment is still pending confirmation. Your QR will unlock automatically once MTN MoMo confirms the charge.',
                  ...
                  child: SizedBox(
                    ...
                    child: isGateReady
                        ? QrImageView(
                            ...
                            eyeStyle: const QrEyeStyle(color: AppColors.rsBlue),
