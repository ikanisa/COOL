...
final coolAchievementsProvider = FutureProvider.autoDispose.family<List<CoolAchievement>, String>((ref, userId) async {
...
final earnedAchievementsProvider = Provider.autoDispose.family<AsyncValue<List<CoolAchievement>>, String>((ref, userId) {
  final allAsync = ref.watch(coolAchievementsProvider(userId));
  
  return allAsync.whenData((list) => list.where((a) => a.isEarned).toList());
});
