    ...
    if (activeGroupGoalPercent >= 70 && activeGroupGoalPercent < 100) {
      quests.add(
        CoolQuest(
          ...
          subtitle: 'activeGroupGoalPercent of goal contribute',
          route: '/groups',
          priority: 85,
        ),
      );
    ...
    if (tripStreakCount > 0 && tripStreakCount % 5 == 4) {
      quests.add(
        CoolQuest(
          ...
          title: 'One more trip!',
          subtitle: '${tripStreakCount + 1} trips for a',
          route: '/mobility',
          priority: 75,
        ),
      );
    ...
    if (pendingMomoCount > 0) {
      quests.add(
        CoolQuest(
          ...
          subtitle:
              'pendingMomoCount pending MoMo confirmation?',
          route: '/momo',
          priority: 80,
        ),
      );
