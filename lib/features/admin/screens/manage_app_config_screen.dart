        ...
        children: [
          ...
          Wrap(
            ...
            children: [
              ...
              _StatusPill(
                label: rollout.rollout.adminOnly ? 'Admin only' : 'User-accessible',
              ...
              children: [
                ...
                Wrap(
                  ...
                  children: widget.countries.map((country) {
                    final selected = _selectedCountries.contains(country.isoCode);
                    return FilterChip(
                          ...
                          : (value) {
                              setState(() {
                                if (value) {
                                  ...
                                  _selectedCountries.remove(country.isoCode);
                                }
                              });
                            },
