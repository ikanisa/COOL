...
class RsMatch extends Equatable {
  ...
  bool isAccessibleForTier(FanTier tier) {
    ...
    final accessStart = switch (tier) {
      ...
      FanTier.bronze => saleStartsAt.subtract(const Duration(hours: 24)),
      FanTier.fan => saleStartsAt,
    };
  ...
  factory RsMatch.fromJson(RsJsonMap json) {
    ...
    return RsMatch(
      ...
      roster: _asList(json['roster']).map((e) => e.toString()).toList(),
    );
  }
