...
part 'rs_engagement_models.dart';
...
enum FanTier {
  ...
  static const fan = blue;
  static const bronze = silver;
}

extension FanTierX on FanTier {
  static FanTier fromValue(String? value) {
    return switch ((value ?? '').toLowerCase()) {
      'fan' || 'blue' => FanTier.blue,
      'bronze' || 'silver' => FanTier.silver,
      'gold' => FanTier.gold,
  ...
  Color get color => switch (this) {
    FanTier.blue => RsColors.rsRed,
    FanTier.silver => const Color(0xFFCD7F32),
  ...
  Color get glowColor => switch (this) {
    FanTier.blue => RsColors.rsRed.withValues(alpha: 0.4),
    FanTier.silver => const Color(0xFFCD7F32).withValues(alpha: 0.4),
...
extension ProductCategoryX on ProductCategory {
  ...
  Color get defaultBackgroundColor => switch (this) {
    ProductCategory.kits => RsColors.rsNavyLight.withValues(alpha: 0.24),
    ...
    ProductCategory.scarves => RsColors.rsRed.withValues(alpha: 0.20),
