                ...
                children: [
                  CoolCard(
                    gradient: LinearGradient(
                      ...
                      colors: [
                        RsColors.rsRed.withValues(alpha: 0.94),
        ...
        children: [
          Container(
            ...
            decoration: BoxDecoration(
              color: RsColors.rsRed.withValues(alpha: 0.14),
              borderRadius: BorderRadius.circular(CoolRadii.lg),
              border: Border.all(color: RsColors.rsRed.withValues(alpha: 0.2)),
            ),
            alignment: Alignment.center,
            child: Icon(metric.icon, size: 22, color: RsColors.rsNavyLight),
          ),
