          ...
          membersAsync.whenOrNull(
                data: (members) {
                  ...
                  return Padding(
                    ...
                    child: Row(
                      children: [
                        _TierChip('💙', 'Blue', tierCounts[FanTier.fan] ?? 0),
                        const SizedBox(width: 6),
                        _TierChip(
                          '🥈',
                          'Silver',
                          tierCounts[FanTier.bronze] ?? 0,
                        ),
                        const SizedBox(width: 6),
        ...
        child: Row(
          children: [
            Container(
              ...
              child: Icon(section.icon, size: 22, color: RsColors.rsNavyLight),
            ),
    ...
    return GestureDetector(
      ...
      child: Container(
        ...
        decoration: BoxDecoration(
          ...
          border: Border.all(color: RsColors.rsRed.withValues(alpha: 0.3)),
        ),
        child: Row(
          mainAxisSize: MainAxisSize.min,
          children: [
            Icon(icon, size: 14, color: RsColors.rsRed),
            const SizedBox(width: 6),
            Text(
              label,
              style: GoogleFonts.dmSans(
