            ...
            child: TextField(
              ...
              decoration: InputDecoration(
                ...
                focusedBorder: OutlineInputBorder(
                  borderRadius: BorderRadius.circular(CoolRadii.lg),
                  borderSide: const BorderSide(color: RsColors.rsRed),
                ),
    ...
    return Expanded(
      child: GestureDetector(
        ...
        child: AnimatedContainer(
          ...
          decoration: BoxDecoration(
            color: isSelected
                ? RsColors.rsRed.withValues(alpha: 0.16)
                : colors.chipBackground,
            borderRadius: BorderRadius.circular(14),
            border: Border.all(
              color: isSelected ? RsColors.rsRed : colors.border,
            ),
          ),
          child: Text(
            label,
            style: GoogleFonts.dmSans(
              fontSize: 13,
              fontWeight: FontWeight.w800,
              color: isSelected ? RsColors.rsNavyLight : colors.secondaryText,
            ),
          ),
        ),
      ),
      ...
      child: GestureDetector(
        ...
        child: Container(
          ...
          child: Row(
            mainAxisSize: MainAxisSize.min,
            children: [
              Icon(icon, size: 16, color: RsColors.rsNavyLight),
              const SizedBox(width: 6),
              Text(
                label,
                style: GoogleFonts.dmSans(
