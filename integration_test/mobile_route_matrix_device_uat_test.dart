...
const _routeSpecs = <_RouteSpec>[
  ...
  _RouteSpec('offline', '/offline', 'utility'),
  ...
  _RouteSpec('share-invalid', '/share/invalid', 'utility'),
  _RouteSpec('share-expired', '/share/expired', 'utility'),
  _RouteSpec('share-expired-request', '/share/expired/request', 'utility'),
  ...
  _RouteSpec('privacy-alias', '/settings/privacy', 'utility'),
